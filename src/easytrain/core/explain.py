    ...
    return {
        ...
        "resolved": {
            ...
            "hardware": {
                ...
                "capability": list(plan.hardware.capability)
                if plan.hardware.capability
                else None,
...
args = TrainingArguments(
    ...
    learning_rate={lr},
    eval_strategy={args.get("eval_strategy", args.get("evaluation_strategy", "epoch"))!r},
    bf16={bf16},
    fp16={fp16},
    optim={plan.speed.optim!r},
    report_to=[],
)
